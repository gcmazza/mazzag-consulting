...
4. Tell Team Leader. It'll fold the lesson into the next spec.
...
If it's the **Engineer** seat misbehaving: there's nothing to re-upload — it boots from the repo itself. Close the session, open a new one, re-attach the repo.
...
2. Attach your office repo in the Code tab. Engineer boots. Re-upload the other seats' boot cards (Settings → Skills, from `seats/`).
