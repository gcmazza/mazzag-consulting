...
3. **PR 2 — the one screen.** Team Leader specs it from your idea; Engineer builds it and self-audits against the gate; Creative Director's work is reviewed and audited; the render receipts come back attached to the PR. Yes, even for one screen — *especially* for one screen, because this screen is briefly your entire app. Team Leader audits, you merge.
