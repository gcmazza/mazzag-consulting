...
3. **Pages, one PR each, in Top-10 order.** For each page: Team Leader writes the spec, Engineer builds it and **self-audits against the done-gate below** (RULE 1 — the checklist result goes in the PR), Team Leader audits the audit, you merge. Every PR description teaches: what changed, why, and one thing worth learning.
